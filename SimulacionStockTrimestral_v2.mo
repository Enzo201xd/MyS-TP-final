model SimulacionStockMensual
  ...
  Real libreria_ingreso_mensual;   // NUEVO: ingreso mensual de Librería

  Real presto_consumo;
  Real presto_rvc;
  Real presto_precio_venta;
  Real presto_compra_mensual;
  Real presto_ingreso_mensual;    // NUEVO: ingreso mensual de Prestobarbas

  Real ingreso_total_mensual;     // NUEVO: ingreso total del período (ambas líneas)
...
equation
  ...
  libreria_ingreso_mensual = libreria_compra_mensual * libreria_precio_venta;   // NUEVO
  ...
  presto_ingreso_mensual = presto_compra_mensual * presto_precio_venta;        // NUEVO

  // --- TOTAL CONSOLIDADO ---
  ingreso_total_mensual = libreria_ingreso_mensual + presto_ingreso_mensual;   // NUEVO
